module more_flags_module(
  ...
  wire [63:0] new_third;
  wire [3:0] one_hot_sel_548;
  wire and_509;
  wire and_573;
  wire [59:0] one_hot_sel_559;
  wire and_576;
  ...
  assign eq_489 = ____state_1[55:0] == 56'h44_4444_4444_4444;
  assign eq_490 = user_module__reading_data == 8'h44;
  assign eq_495 = ____state_8 == 4'h7;
  ...
  assign and_515 = eq_495 & ~(eq_489 & eq_490);
  assign and_517 = eq_495 & eq_489 & eq_490;
  ...
  assign concat_547 = {~eq_495 & p0_stage_done, eq_495 & p0_stage_done};
  assign new_delay = ____state_8 + 4'h1;
  assign concat_558 = {~eq_495 & p0_stage_done, and_515 & p0_stage_done, and_517 & p0_stage_done};
  ...
  assign one_hot_sel_548 = 4'h0 & {4{concat_547[0]}} | new_delay & {4{concat_547[1]}};
  assign and_509 = eq_489 & eq_490;
  assign and_573 = eq_495 & p0_stage_done;
  assign one_hot_sel_559 = 60'h000_0000_0000_0005 & {60{concat_558[0]}} | 60'h000_0000_0000_000a & {60{concat_558[1]}} | new_output_slice_reduced & {60{concat_558[2]}};
  assign and_576 = (~eq_495 | and_515 | and_517) & p0_stage_done;
  ...
  always_ff @ (posedge clk) begin
    if (reset) begin
      ...
      ____state_8 <= p0_stage_done ? one_hot_sel_548 : ____state_8;
      ____state_7 <= and_576 ? one_hot_sel_559 : ____state_7;
      ____state_11 <= and_573 ? and_509 : ____state_11;
